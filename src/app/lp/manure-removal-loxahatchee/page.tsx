...
export const metadata: Metadata = {
  title: "Farm Services Loxahatchee FL | Waste Removal | Call (561) 576-7667",
...
export default async function LpManureLoxahatchee() {
  const { slotsLeft, reviewCount, avgRating } = await getLandingPageData();

  return (
    <>
      <LandingHero
        title="Loxahatchee Farm & Property Services"
