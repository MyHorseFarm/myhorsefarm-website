...
export const metadata: Metadata = {
  title: "Junk Removal Services | My Horse Farm",
  description:
    "Affordable junk removal and hauling services for homes and businesses in Royal Palm Beach, Wellington and Loxahatchee, Florida. We remove appliances, furniture, yard waste, construction debris and more with transparent pricing starting at $75 per ton.",
  robots: "index, follow",
  ...
  openGraph: {
    title: "Junk Removal Services | My Horse Farm",
    description:
      "Affordable junk removal and hauling in Royal Palm Beach, Wellington and Loxahatchee, FL. Transparent pricing starting at $75 per ton.",
    type: "website",
  ...
  twitter: {
    ...
    title: "Junk Removal Services | My Horse Farm",
    description:
      "Affordable junk removal and hauling in Royal Palm Beach, Wellington and Loxahatchee, FL. Starting at $75 per ton.",
    ...
    <>
      ...
      <main>
        <section className="py-15 px-5 max-w-[1200px] mx-auto max-md:py-10 max-md:px-4">
          <h2 className="text-2xl max-md:text-xl">
            Comprehensive Junk Removal &amp; Hauling
          </h2>
          <p>
            Is clutter taking over your property? Our junk removal service
            handles everything from household items and appliances to yard debris
            and construction waste. With our dump trailer and heavy&#8209;duty
            trucks, we&apos;ll haul it all away quickly and responsibly.
          </p>

          <h3 className="text-primary-dark">Why Choose Our Junk Removal?</h3>
          ...
          <p>
            We help homeowners, equestrian farms and businesses clear out
            furniture, appliances, electronics, yard waste, construction debris
            and more. If it can fit in our dump trailer, we&apos;ll haul it!
          </p>

          <h3 className="text-primary-dark">Service Area</h3>
          <p>
            We provide junk removal throughout Royal Palm Beach, Wellington,
            Loxahatchee, Loxahatchee Groves and nearby Palm Beach County
            communities. Contact us if you&apos;re nearby—we may be able to
      ...
      <SchemaMarkup
        schema={{
          ...
          description:
            "Affordable junk removal and hauling services for residential and commercial clients. We remove furniture, appliances, yard debris and construction waste starting at just $75 per ton.",
        }}
      />
      <SchemaMarkup
        schema={{
