...
export default function JunkRemovalLoxahatcheePage() {
  return (
    <>
      <Hero
        title="Junk Removal in Loxahatchee"
      ...
      <main>
        <section className="py-15 px-5 max-w-[1200px] mx-auto max-md:py-10 max-md:px-4">
          ...
          <p>
            ...
            in Loxahatchee. From broken fencing and old tack to appliances, yard
      ...
      <SchemaMarkup
        schema={{
          ...
          description:
            "Same\u2011day junk removal starting at $75 per ton in Loxahatchee, FL.",
          sameAs: [
        ...
        schema={{
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 3,
              name: "Loxahatchee",
              item: "https://www.myhorsefarm.com/junk-removal/loxahatchee",
            },
          ],
        }}
      />
